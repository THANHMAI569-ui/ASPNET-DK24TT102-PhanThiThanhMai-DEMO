...
% Trong so do dung gian dong don. Neu giu 1.5 nhu than bai thi moi o nhieu
% dong se cao them gan mot nua, cac o chong len nhau va duong noi cat qua o.
\AtBeginEnvironment{tikzpicture}{\setstretch{1.0}\selectfont}
