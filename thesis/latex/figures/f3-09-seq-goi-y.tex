...
\begin{tikzpicture}[x=3.4cm, y=1.15cm]
  ...
  \foreach \x in {0,1,2,3,4} \draw[seqlife] (\x,-0.5) -- (\x,-20.55);
  ...
  \draw[seqret] (1,-20.05) -- node[above=2pt, fill=white, inner sep=2pt, font=\scriptsize, text width=3.0cm, align=center]{18. Lưới món kèm nhãn ``Đủ nguyên liệu'' hoặc ``Thiếu N nguyên liệu''} (0,-20.05);
