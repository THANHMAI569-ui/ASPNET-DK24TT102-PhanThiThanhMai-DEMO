        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuPlans_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuPlanItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuPlanItems_MenuPlans_MenuPlanId",
                        column: x => x.MenuPlanId,
                        principalTable: "MenuPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuPlanItems_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuPlanItems_MenuPlanId",
                table: "MenuPlanItems",
                column: "MenuPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuPlanItems_RecipeId",
                table: "MenuPlanItems",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuPlans_UserId",
                table: "MenuPlans",
                column: "UserId");
