...
{\raggedright Trích từ \codelong{src/CookingAdvisor.Tests/Services/RecipeServiceSortTests.cs}. Ca
kiểm thử này đã được xác nhận là có hiệu lực bằng cách tạm gỡ khóa sắp xếp phụ
khỏi mã nguồn và quan sát ca kiểm thử chuyển sang trạng thái không đạt:\par}
