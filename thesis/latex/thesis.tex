...
% Font toan lay ban TeX Gyre Termes: day la ban Times cua bo ky hieu toan, nho
% do cac ky hieu (giao, hop, tap rong, tri tuyet doi) cung mot dang chu voi
% phan chu Times New Roman thay vi lech sang XITS.
...
\usepackage[top=2cm, bottom=2cm, left=3cm, right=2cm,
            headheight=17pt, headsep=5pt, footskip=0.9cm]{geometry}

% === Gian dong 1.5, cach doan 6pt (quy dinh TVU) =============
\usepackage{setspace}
\setstretch{1.5}
\usepackage{parskip}
% Quy dinh: gian cach doan truoc 6pt va sau 6pt. Word cong ca hai nen khe ho
% giua hai doan lien tiep la 12pt; LaTeX chi co mot tham so \parskip nen dat
% thang 12pt de ra dung khoang cach do.
...
\usepackage{fancyhdr}
% Dau trang chi mang ten de tai rut gon: o 13pt, ten day du cong voi ten
% GVHD vuot qua 16cm khoi chu va hai khoi trai/phai se de len nhau.
\newcommand{\dttendetai}{Website gợi ý nấu ăn và lập thực đơn}
\newcommand{\dtgvhd}{GV hướng dẫn: TS. Đoàn Minh Phước}
\newcommand{\dtsvth}{SVTH: Phan Thị Thanh Mai}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\itshape\dttendetai}
\fancyhead[R]{\itshape\dtgvhd}
\fancyfoot[L]{\dtsvth}
\fancyfoot[R]{\thepage}
...
\usepackage{titlesec}
% Tieu de chuong mot dong "CHUONG n. TEN", can giua, dam, 14pt: co chu theo
% mau 4_MAU_BAO_CAO.doc, dau cham theo muc 2 cua ban quy dinh.
...
% Chu thich hinh, bang giu nguyen co 13pt nhu than bai (mau cua khoa khong thu
% nho chu trong bang lan chu thich).
...
\AtBeginEnvironment{tabular}{\setstretch{1.0}\raggedright\arraybackslash}
\AtBeginEnvironment{tabularx}{\setstretch{1.0}\raggedright\arraybackslash}
\AtBeginEnvironment{longtable}{\setstretch{1.0}\raggedright\arraybackslash}
